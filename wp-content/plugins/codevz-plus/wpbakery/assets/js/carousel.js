...
jQuery( function( $ ) {
    ...
    if ( $( 'body.single' ).length && $( '.related.products, .cz_related_posts' ).length ) {

        var related = $( '.related.products, .cz_related_posts' ),
            slidesToShow = related.attr( 'data-col' ),
            slidesToShow = slidesToShow ? slidesToShow : parseInt( related.find( 'ul.products' ).attr( 'class' ).match( /columns-(\d+)/)?.[1] || 3 );

        related.addClass( 'codevz-plus-related-carousel no_dots' );
        related.attr( 'data-slick-prev', 'fa fa-chevron-left' );
        related.attr( 'data-slick-next', 'fa fa-chevron-right' );
        related.attr( 'data-slick', '{"selector":"","slidesToShow":' + slidesToShow + ',"slidesToScroll":1,"rows":1,"fade":false,"vertical":false,"verticalSwiping":false,"infinite":true,"speed":1000,"swipeToSlide":true,"centerMode":false,"centerPadding":"","variableWidth":false,"autoplay":false,"autoplaySpeed":4000,"dots":true,"counts":false,"responsive":[{"breakpoint":769,"settings":{"slidesToShow":2,"slidesToScroll":1,"infinite":true,"touchMove":true}},{"breakpoint":481,"settings":{"slidesToShow":1,"slidesToScroll":1,"infinite":true,"touchMove":true}}]}' );
		...
		$( '[data-slick]' ).not( '.cz_popup_modal:not(.cz_show_popup) [data-slick]' ).codevzPlus( 'slick', function( x ) {
			...
			var opt = x.data( 'slick' ),
				selector = function( selector ) {
					...
					} else if ( $( '.cz_related_posts_inner', selector ).length ) {
                        return $( '.cz_related_posts_inner', selector );
                ...
                if ( $( 'body.single' ).length ) {
                    ...
                    dis.on( 'init reInit beforeChange', function( event, slick, currentSlide, nextSlide ) {
                        ...
                        $this.each( function() {
                            ...
                            if ( ! $this.closest( '.codevz-plus-related-carousel' ).find( '.codevz-plus-related-arrows' ).length ) {

                                $( '<div class="codevz-plus-related-arrows" />' ).append( $this.find( '.slick-arrow' ).removeClass( 'slick-arrow' ) ).appendTo( $this.closest( '.codevz-plus-related-carousel' ).find( '> h1, > h2, > h3, > h4' ) );
			...
			if ( ( wpb || $( '.elementor-editor-active' ).length ) && typeof Codevz != 'undefined' ) {
